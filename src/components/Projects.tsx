...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      title: "Chess",
      description:
        "Real-Time Chess Platform – A full-stack, multiplayer chess experience featuring live gameplay, in-game chat, and move history tracking. Designed with a dedicated WebSocket architecture for instant, smooth UI updates while keeping the server as the single source of truth for secure move validation. Built with performance, fairness, & user experience",
      tech: [
        "React.js",
        "Node.js",
        "Postgres",
                  ...
                  >
                    ...
                    >
                      <CardContent className="p-8 space-y-6 h-full flex flex-col">
                        ...
                        <div className="space-y-4 pt-4 border-t border-minimal-border-subtle/50">
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                variant="outline"
                                className="w-full bg-minimal-surface hover:bg-minimal-surface-soft border-minimal-border-subtle rounded-xl py-4 text-sm font-light tracking-wide text-minimal-text-secondary"
                              >
                                View Tech Stack
                              </Button>
                            </TooltipTrigger>
                            <TooltipContent
                              side="top"
                              className="max-w-xs text-center p-4 bg-minimal-surface-soft border-minimal-border-subtle rounded-xl"
                            >
                              <p className="font-light text-sm text-minimal-text-muted tracking-wide leading-relaxed">
                                {project.tech.join(" • ")}
                              </p>
                            </TooltipContent>
                          </Tooltip>
